---
title: 'Potential for Marine Aquaculture Along the West Coast'
...
meat production.[^1] [Gentry et al.](https://www.nature.com/articles/s41559-017-0257-9) mapped the
potential for marine aquaculture globally based on multiple constraints,
including ship traffic, dissolved oxygen, bottom depth .[^2]
...
To start, I loaded in and organized all necessary data and make sure it has the
...
I then created a check to ensure that the extent, resolution, and CRS of bathymetry and temprature raster layers matched.
...
Finally, I created two maps showing 1) the total suitable oyster aquaculture habitat area by region, and 2) the percent suiatble oyster aquaculture habitat area by region
...
I wanted to test out this function on Kelp Crabs as they are widely dispersed and could potentially make a good candidate for aquaculutre. Data on the Kelp Crab was obtained from [SeaLifeBase](https://www.sealifebase.ca/search.php) which presents habitat information on thousands of species. Lets take a look:

```{r}
ideal_crib_for_a_species("Kelp Crab", depth_min = -98, depth_max =  0, temp_min = 7.8, temp_max =  12.8)
```

And there you have it! This is how I used spatial analysis tools in R to figure out where potential oyster (and any other species) aquaculture might be by EEZ along the west coast of the Unitied States.
